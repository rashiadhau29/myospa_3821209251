...
import client1Logo from '../../public/img/travellogo1.jpg';
import client2Logo from '../../public/img/travellogo2.jpg';
import client3Logo from '../../public/img/travellogo3.png';
    ...
    <div className="container mx-auto px-4 py-16">
     ...
     <div className="relative text-center mb-16 mt-5 rounded-2xl overflow-hidden h-[200px] md:h-[250px]">
      ...
      <section className="mb-16">
        <h2 className="text-2xl font-bold text-center mb-10">Some Esteemed Travel & Transport Clients</h2>
       
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 px-4">
          {[
            { name: "SG Tours & Travels", logo: client1Logo },
            { name: "MDTC Group", logo: client2Logo },
            { name: "Car POOL", logo: client3Logo }
          ].map((client, index) => (
